...
export const StyledButton = styled(Button)(({ theme, variant }) => ({
  ...
  border: variant === "outlined" ? `${"1.5px solid" + theme.palette.secondary.main}` : "",
  boxShadow: "none !important",
  "&.MuiButton-root:hover": {
    backgroundColor: variant === "contained" ? `${theme.palette.secondary.containedHover + "!important"}` : `${theme.palette.secondary.outlinedHover + "!important"}`,
    boxShadow: "none !important",
    border: variant === "outlined" ? `${"1.5px solid" + theme.palette.secondary.main}` : "",
  },
  "&.Mui-disabled": {
